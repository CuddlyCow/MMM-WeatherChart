          ...
          datasets: [
            {
              ...
              data: temperatures,
              hidden: !moduleInstance.config.display.maximumTemperature,
              borderWidth: 4,
            ...
            },
            {
              ...
              hidden: useHourlyForecast || !moduleInstance.config.display.minimumTemperature,
              borderWidth: 3,
              borderDash: [7, 5],
              cubicInterpolationMode: "monotone",
              tension: 0.35,
            ...
            },
            {
              ...
              data: precipitation,
              hidden: !moduleInstance.config.display.precipitation,
              borderWidth: 1,
        ...
        options: {
          ...
          scales: {
            ...
            y: {
              ...
              ticks: {
                display: moduleInstance.config.display.yAxisLabels,
                stepSize: 1,
                autoSkip: false,
            ...
            y1: {
              type: "linear",
              display: moduleInstance.config.display.precipitation,
              position: "right",
              beginAtZero: true,
